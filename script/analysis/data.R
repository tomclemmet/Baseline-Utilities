...
write_csv(rounds_sum, "output/data/rounds-sum.csv")

# Appendix A: Old vs New OLS Regression results -------------------------------
...
ggsave("output/data/old-v-new-means.png", width = 7, height = 4)
...
write_csv(etab, "output/data/old-v-new-etab.csv")
...
hse |> 
  ...
  geom_density(aes(x = Value), fill = "#31446b", linewidth = 0) +
...
ggsave("output/data/age-hsuv-dists.png", height = 4, width = 8)
...
hse |>
  ...
  guides(colour = "none")
ggsave("output/data/ovr-means.png", height = 4, width = 7)
...
ggsave("output/data/std-devs.png", height = 4, width = 7)
